          ...
          <div className="bg-[var(--brand-surface)] dark:bg-gray-950 rounded-2xl p-6 sm:p-8 border border-[var(--brand-line)] dark:border-gray-800 shadow-sm">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full py-3.5 mt-2 bg-[var(--brand-primary)] hover:opacity-90 text-white rounded-xl font-bold text-base transition-all shadow-sm active:scale-[0.98] disabled:opacity-60"
              >
